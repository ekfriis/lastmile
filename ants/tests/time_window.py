...
class TestTimeWindow(unittest.TestCase):
   ...
   def test_malformed(self):
      ...
      self.assertRaises(ValueError, timing.TimeWindow, 
   ...
   def test_sort(self):
      ...
      unordered.sort()
      self.assertEquals(unordered, [self.before_five, self.around_noon, 
         self.after_three])
